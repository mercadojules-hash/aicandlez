-- Jarvis Desktop Edition — Database Schema (jarvis_* + users)
-- Generated 2026-06-08 via pg_dump 16 (schema-only, --no-owner --no-privileges)
-- pgvector required for jarvis_embeddings (vector(1536), HNSW cosine).
...
CREATE TABLE public.jarvis_agent_messages (
...
CREATE TABLE public.jarvis_agent_runs (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    agent_id uuid,
...
CREATE TABLE public.jarvis_agent_trust (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    agent_id uuid,
    agent_name character varying(200),
    agent_type character varying(48),
...
CREATE TABLE public.jarvis_aicandlez_daily_snapshots (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE public.jarvis_approvals (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE public.jarvis_audit_logs (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: jarvis_brand_profiles; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.jarvis_brand_profiles (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE public.jarvis_briefings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    title character varying(200) NOT NULL,
    summary text,
    content text,
...
CREATE TABLE public.jarvis_budgets (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name character varying(200) NOT NULL,
    description text,
...
CREATE TABLE public.jarvis_businesses (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name character varying(200) NOT NULL,
...
CREATE TABLE public.jarvis_code_files (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE public.jarvis_cognition_runs (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: jarvis_creative_assets; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.jarvis_creative_assets (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    business_id uuid,
    campaign_id uuid,
    agent character varying(48) DEFAULT 'prometheus'::character varying NOT NULL,
    kind character varying(48) NOT NULL,
    ...
    citations jsonb,
    grounding_score integer,
    source_mode character varying(32) DEFAULT 'cognition'::character varying NOT NULL,
    cognition_run_id uuid,
    governance_state character varying(32) DEFAULT 'none'::character varying NOT NULL,
    approval_id uuid,
    status character varying(32) DEFAULT 'draft'::character varying NOT NULL,
...
--
-- Name: jarvis_creative_campaigns; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.jarvis_creative_campaigns (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    business_id uuid,
    name character varying(200) NOT NULL,
    objective text,
    channel character varying(64) DEFAULT 'multi'::character varying NOT NULL,
    audience text,
...
CREATE TABLE public.jarvis_credentials (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    business_id uuid,
    system_id uuid,
    name character varying(200) NOT NULL,
...
CREATE TABLE public.jarvis_delegations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    from_agent_id uuid,
    from_agent_name character varying(200),
    to_agent_id uuid,
...
CREATE TABLE public.jarvis_embeddings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE public.jarvis_escalation_chain_steps (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    chain_id uuid,
...
CREATE TABLE public.jarvis_escalation_chains (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name character varying(200) NOT NULL,
    description text,
    enabled boolean DEFAULT true NOT NULL,
...
CREATE TABLE public.jarvis_escalations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    title character varying(200) NOT NULL,
    description text,
...
CREATE TABLE public.jarvis_findings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    title character varying(200) NOT NULL,
    summary text,
    detail text,
...
CREATE TABLE public.jarvis_infra_resources (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    business_id uuid,
    system_id uuid,
...
CREATE TABLE public.jarvis_knowledge_assets (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    title character varying(200) NOT NULL,
    summary text,
    content text,
...
CREATE TABLE public.jarvis_knowledge_categories (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name character varying(200) NOT NULL,
    slug character varying(140) NOT NULL,
    description text,
...
CREATE TABLE public.jarvis_knowledge_relationships (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE public.jarvis_policies (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name character varying(200) NOT NULL,
    description text,
    scope_type character varying(32) DEFAULT 'global'::character varying NOT NULL,
...
CREATE TABLE public.jarvis_policy_evaluations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    policy_id uuid,
...
CREATE TABLE public.jarvis_recommendations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    title character varying(200) NOT NULL,
    rationale text,
    action text,
...
CREATE TABLE public.jarvis_render_services (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE public.jarvis_reports (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    business_id uuid,
...
CREATE TABLE public.jarvis_repositories (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    system_id uuid,
    business_id uuid,
...
CREATE TABLE public.jarvis_routing_rules (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name character varying(200) NOT NULL,
    description text,
...
CREATE TABLE public.jarvis_runbooks (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    system_id uuid,
    business_id uuid,
    title character varying(240) NOT NULL,
...
CREATE TABLE public.jarvis_voice_sessions (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    status character varying(32) DEFAULT 'active'::character varying NOT NULL,
    business_id uuid,
    created_by character varying(255),
...
CREATE TABLE public.jarvis_voice_turns (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    session_id uuid,
...
CREATE TABLE public.jarvis_workflow_runs (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    workflow_id uuid,
...
CREATE TABLE public.jarvis_workflow_steps (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    workflow_run_id uuid,
...
CREATE TABLE public.jarvis_workflows (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name character varying(200) NOT NULL,
    description text,
...
CREATE TABLE public.users (
    ...
    plan_status character varying(50) DEFAULT 'none'::character varying NOT NULL,
    stripe_customer_id character varying(255),
    stripe_subscription_id character varying(255),
    billing_email character varying(255),
    trial_ends_at timestamp without time zone,
    ai_disclaimer_accepted_at timestamp without time zone,
    ai_disclaimer_version character varying(32),
    ai_disclaimer_ip character varying(64),
    perf_fee_bps_override integer,
    fee_waiver_active boolean DEFAULT false NOT NULL,
    fee_waiver_until timestamp without time zone,
...
--
-- Name: jarvis_brand_profiles jarvis_brand_profiles_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jarvis_brand_profiles
    ADD CONSTRAINT jarvis_brand_profiles_pkey PRIMARY KEY (id);
...
--
-- Name: jarvis_creative_assets jarvis_creative_assets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jarvis_creative_assets
    ADD CONSTRAINT jarvis_creative_assets_pkey PRIMARY KEY (id);


--
-- Name: jarvis_creative_campaigns jarvis_creative_campaigns_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jarvis_creative_campaigns
    ADD CONSTRAINT jarvis_creative_campaigns_pkey PRIMARY KEY (id);
...
CREATE INDEX jarvis_aicandlez_daily_snapshots_date_idx ON public.jarvis_aicandlez_daily_snapshots USING btree (snapshot_date);


--
-- Name: jarvis_brand_profiles_business_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX jarvis_brand_profiles_business_idx ON public.jarvis_brand_profiles USING btree (business_id);
...
CREATE INDEX jarvis_code_files_artifact_idx ON public.jarvis_code_files USING btree (artifact);
...
CREATE INDEX jarvis_code_files_kind_idx ON public.jarvis_code_files USING btree (kind);


--
-- Name: jarvis_creative_assets_business_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX jarvis_creative_assets_business_idx ON public.jarvis_creative_assets USING btree (business_id);


--
-- Name: jarvis_creative_assets_campaign_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX jarvis_creative_assets_campaign_idx ON public.jarvis_creative_assets USING btree (campaign_id);


--
-- Name: jarvis_creative_assets_kind_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX jarvis_creative_assets_kind_idx ON public.jarvis_creative_assets USING btree (kind);


--
-- Name: jarvis_creative_campaigns_business_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX jarvis_creative_campaigns_business_idx ON public.jarvis_creative_campaigns USING btree (business_id);


--
-- Name: jarvis_creative_campaigns_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX jarvis_creative_campaigns_status_idx ON public.jarvis_creative_campaigns USING btree (status);
...
CREATE INDEX jarvis_credentials_business_idx ON public.jarvis_credentials USING btree (business_id);
...
CREATE INDEX jarvis_embeddings_business_idx ON public.jarvis_embeddings USING btree (business_id);
...
CREATE INDEX jarvis_embeddings_created_by_idx ON public.jarvis_embeddings USING btree (created_by);
...
CREATE INDEX jarvis_embeddings_hnsw_idx ON public.jarvis_embeddings USING hnsw (embedding public.vector_cosine_ops);
...
CREATE UNIQUE INDEX jarvis_embeddings_subject_model_uq ON public.jarvis_embeddings USING btree (subject_type, subject_id, model);
...
CREATE INDEX jarvis_infra_resources_business_idx ON public.jarvis_infra_resources USING btree (business_id);
...
CREATE UNIQUE INDEX jarvis_infra_resources_type_name_uq ON public.jarvis_infra_resources USING btree (resource_type, name);
...
CREATE UNIQUE INDEX jarvis_memories_source_uq ON public.jarvis_memories USING btree (source_type, source_id);
...
CREATE INDEX jarvis_render_services_name_idx ON public.jarvis_render_services USING btree (name);
...
CREATE INDEX jarvis_reports_business_idx ON public.jarvis_reports USING btree (business_id);
...
CREATE INDEX jarvis_reports_created_at_idx ON public.jarvis_reports USING btree (created_at);
...
CREATE INDEX jarvis_reports_type_idx ON public.jarvis_reports USING btree (report_type);
...
CREATE INDEX jarvis_repositories_business_idx ON public.jarvis_repositories USING btree (business_id);
...
CREATE INDEX jarvis_repositories_system_idx ON public.jarvis_repositories USING btree (system_id);
...
CREATE INDEX jarvis_runbooks_system_idx ON public.jarvis_runbooks USING btree (system_id);
...
CREATE INDEX jarvis_systems_business_idx ON public.jarvis_systems USING btree (business_id);
...
CREATE INDEX jarvis_voice_sessions_created_by_idx ON public.jarvis_voice_sessions USING btree (created_by);
...
CREATE INDEX jarvis_voice_sessions_status_idx ON public.jarvis_voice_sessions USING btree (status);
...
CREATE INDEX jarvis_voice_turns_created_at_idx ON public.jarvis_voice_turns USING btree (created_at);
...
CREATE INDEX jarvis_voice_turns_session_idx ON public.jarvis_voice_turns USING btree (session_id);
...
--
-- Name: jarvis_brand_profiles jarvis_brand_profiles_business_id_jarvis_businesses_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jarvis_brand_profiles
    ADD CONSTRAINT jarvis_brand_profiles_business_id_jarvis_businesses_id_fk FOREIGN KEY (business_id) REFERENCES public.jarvis_businesses(id) ON DELETE CASCADE;
...
--
-- Name: jarvis_creative_assets jarvis_creative_assets_approval_id_jarvis_approvals_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jarvis_creative_assets
    ADD CONSTRAINT jarvis_creative_assets_approval_id_jarvis_approvals_id_fk FOREIGN KEY (approval_id) REFERENCES public.jarvis_approvals(id) ON DELETE SET NULL;


--
-- Name: jarvis_creative_assets jarvis_creative_assets_business_id_jarvis_businesses_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jarvis_creative_assets
    ADD CONSTRAINT jarvis_creative_assets_business_id_jarvis_businesses_id_fk FOREIGN KEY (business_id) REFERENCES public.jarvis_businesses(id) ON DELETE SET NULL;


--
-- Name: jarvis_creative_assets jarvis_creative_assets_campaign_id_jarvis_creative_campaigns_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jarvis_creative_assets
    ADD CONSTRAINT jarvis_creative_assets_campaign_id_jarvis_creative_campaigns_id FOREIGN KEY (campaign_id) REFERENCES public.jarvis_creative_campaigns(id) ON DELETE SET NULL;


--
-- Name: jarvis_creative_assets jarvis_creative_assets_cognition_run_id_jarvis_cognition_runs_i; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jarvis_creative_assets
    ADD CONSTRAINT jarvis_creative_assets_cognition_run_id_jarvis_cognition_runs_i FOREIGN KEY (cognition_run_id) REFERENCES public.jarvis_cognition_runs(id) ON DELETE SET NULL;


--
-- Name: jarvis_creative_campaigns jarvis_creative_campaigns_business_id_jarvis_businesses_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jarvis_creative_campaigns
    ADD CONSTRAINT jarvis_creative_campaigns_business_id_jarvis_businesses_id_fk FOREIGN KEY (business_id) REFERENCES public.jarvis_businesses(id) ON DELETE SET NULL;


--
-- Name: jarvis_creative_campaigns jarvis_creative_campaigns_cognition_run_id_jarvis_cognition_run; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jarvis_creative_campaigns
    ADD CONSTRAINT jarvis_creative_campaigns_cognition_run_id_jarvis_cognition_run FOREIGN KEY (cognition_run_id) REFERENCES public.jarvis_cognition_runs(id) ON DELETE SET NULL;
