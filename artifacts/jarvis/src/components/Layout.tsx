...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Agent Activity", path: "/agent-activity", icon: Radar },
  { label: "Collaboration", path: "/collaboration", icon: Network },
  { label: "Workflows", path: "/workflows", icon: Workflow },
  { label: "Routing Rules", path: "/routing-rules", icon: Compass },
  { label: "Escalation Chains", path: "/escalation-chains", icon: ShieldAlert },
  { label: "Command Console", path: "/commands", icon: Terminal },
