...
import userExecutionFunnelRouter from "./userExecutionFunnel.js";
import concurrencyRecommendationRouter from "./concurrencyRecommendation.js";
import executionBlockersRouter from "./executionBlockers.js";
import profitReportRouter from "./profitReport.js";
...
import adminExecutionMetricsRouter from "./adminExecutionMetrics.js";
...
import adminReconciliationRouter from "./adminReconciliation.js";
...
import strategyV2DiagnosticsRouter from "./strategyV2Diagnostics.js";
import adminRiskGovernorRouter from "./adminRiskGovernor.js";
import adminOperatorTradeControlsRouter from "./adminOperatorTradeControls.js";
import jarvisExecutiveServiceRouter from "./jarvisExecutiveService.js";
...
router.use(strategyV2DiagnosticsRouter);
router.use(adminRiskGovernorRouter);
router.use(adminOperatorTradeControlsRouter);
router.use(jarvisExecutiveServiceRouter);
...
router.use(concurrencyRecommendationRouter);
router.use(executionBlockersRouter);
...
router.use(adminExecutionMetricsRouter);
