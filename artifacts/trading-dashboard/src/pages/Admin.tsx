...
const MOCK_USERS: PlatformUser[] = [
  { rank:  1, id:"u01", name:"Alex Mercer",    initials:"AM", email:"a.mercer@apex.io",    exchange:"Alpaca",    exColor:"#ffbe00", mode:"live",       positions:3, trades:284, fees:2840, pnl:18450, winRate:68, lastActive:"2m ago",  status:"active",     tier:"enterprise" },
  { rank:  2, id:"u02", name:"Sarah Kim",      initials:"SK", email:"s.kim@apex.io",       exchange:"Binance",   exColor:"#f0b90b", mode:"live",       positions:1, trades:192, fees:1920, pnl:12300, winRate:72, lastActive:"8m ago",  status:"active",     tier:"pro" },
  { rank:  3, id:"u03", name:"Marcus Chen",    initials:"MC", email:"m.chen@apex.io",      exchange:"Coinbase",  exColor:"#2775ca", mode:"live",       positions:2, trades:171, fees:1710, pnl:9820,  winRate:61, lastActive:"15m ago", status:"active",     tier:"pro" },
  { rank:  4, id:"u04", name:"Priya Sharma",   initials:"PS", email:"p.sharma@apex.io",    exchange:"Alpaca",    exColor:"#ffbe00", mode:"live",       positions:1, trades:148, fees:1480, pnl:7640,  winRate:65, lastActive:"1m ago",  status:"active",     tier:"pro" },
  { rank:  5, id:"u05", name:"Tyler Brooks",   initials:"TB", email:"t.brooks@apex.io",    exchange:"Alpaca",    exColor:"#ffbe00", mode:"simulation", positions:0, trades:132, fees:1320, pnl:4210,  winRate:54, lastActive:"32m ago", status:"idle",       tier:"pro" },
  { rank:  6, id:"u06", name:"Yuna Park",      initials:"YP", email:"y.park@apex.io",      exchange:"Crypto.com",exColor:"#1199fa", mode:"live",       positions:2, trades:119, fees:1190, pnl:6830,  winRate:63, lastActive:"5m ago",  status:"active",     tier:"enterprise" },
  { rank:  7, id:"u07", name:"James Okafor",   initials:"JO", email:"j.okafor@apex.io",    exchange:"Binance",   exColor:"#f0b90b", mode:"live",       positions:1, trades:108, fees:1080, pnl:3110,  winRate:58, lastActive:"12m ago", status:"active",     tier:"pro" },
  { rank:  8, id:"u08", name:"Elena Vasquez",  initials:"EV", email:"e.vasquez@apex.io",   exchange:"Coinbase",  exColor:"#2775ca", mode:"simulation", positions:0, trades:97,  fees:970,  pnl:-520,  winRate:48, lastActive:"1h ago",  status:"idle",       tier:"free" },
  { rank:  9, id:"u09", name:"Kai Nakamura",   initials:"KN", email:"k.nakamura@apex.io",  exchange:"Alpaca",    exColor:"#ffbe00", mode:"live",       positions:1, trades:84,  fees:840,  pnl:2940,  winRate:60, lastActive:"22m ago", status:"active",     tier:"pro" },
  { rank: 10, id:"u10", name:"Owen Fitzgerald", initials:"OF", email:"o.fitz@apex.io",     exchange:"Crypto.com",exColor:"#1199fa", mode:"simulation", positions:0, trades:76,  fees:760,  pnl:1620,  winRate:55, lastActive:"3h ago",  status:"idle",       tier:"free" },
  { rank: 11, id:"u11", name:"Diana Reyes",    initials:"DR", email:"d.reyes@apex.io",     exchange:"Alpaca",    exColor:"#ffbe00", mode:"live",       positions:0, trades:61,  fees:610,  pnl:-1240, winRate:42, lastActive:"45m ago", status:"error",      tier:"pro" },
  { rank: 12, id:"u12", name:"Wei Zhang",      initials:"WZ", email:"w.zhang@apex.io",     exchange:"Binance",   exColor:"#f0b90b", mode:"live",       positions:2, trades:53,  fees:530,  pnl:3800,  winRate:66, lastActive:"7m ago",  status:"active",     tier:"pro" },
];
