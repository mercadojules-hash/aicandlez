...
const MOCK_USERS: PlatformUser[] = [
  { rank:  1, id:"u01", name:"Alex Mercer",    initials:"AM", email:"a.mercer@apex.io",    exchange:"Kraken",    exColor:"#5741d9", mode:"live",       positions:3, trades:284, fees:2840, pnl:18450, winRate:68, lastActive:"2m ago",  status:"active",     tier:"enterprise" },
  ...
  { rank:  4, id:"u04", name:"Priya Sharma",   initials:"PS", email:"p.sharma@apex.io",    exchange:"Kraken",    exColor:"#5741d9", mode:"live",       positions:1, trades:148, fees:1480, pnl:7640,  winRate:65, lastActive:"1m ago",  status:"active",     tier:"pro" },
  { rank:  5, id:"u05", name:"Tyler Brooks",   initials:"TB", email:"t.brooks@apex.io",    exchange:"Kraken",    exColor:"#5741d9", mode:"simulation", positions:0, trades:132, fees:1320, pnl:4210,  winRate:54, lastActive:"32m ago", status:"idle",       tier:"pro" },
  ...
  { rank:  9, id:"u09", name:"Kai Nakamura",   initials:"KN", email:"k.nakamura@apex.io",  exchange:"Kraken",    exColor:"#5741d9", mode:"live",       positions:1, trades:84,  fees:840,  pnl:2940,  winRate:60, lastActive:"22m ago", status:"active",     tier:"pro" },
  ...
  { rank: 11, id:"u11", name:"Diana Reyes",    initials:"DR", email:"d.reyes@apex.io",     exchange:"Kraken",    exColor:"#5741d9", mode:"live",       positions:0, trades:61,  fees:610,  pnl:-1240, winRate:42, lastActive:"45m ago", status:"error",      tier:"pro" },
