...
// ── Page ─────────────────────────────────────────────────────────────────────
export default function AdminPortalLegacy() {
...
function PortalInner() {
  // P1 fix (E3): AdminPortalLegacy is only ever mounted by the Portal.tsx
  // dispatcher AFTER role has resolved to admin/super-admin. Forcing the
  // internal role hook to the admin branch removes the dual-resolution race
  // that could transiently cross-mount customer JSX inside this legacy tree.
  const _roleProbe = useUserRole(); void _roleProbe;
  const isAdmin = true;
